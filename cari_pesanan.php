...
<body>
  ...
  <!-- Cari Pesanan -->
  <center><h2>Pencarian Pesanan</h2>
  <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
      <tr>
        <form name="pencarian" method="post" action="cari_pesanan_process.php">
          <td>
            <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
              <br>
              <tr>
                <td width="45"><span class="glyphicon glyphicon-search"></span></td>
                <td width="25">:</td>
                <td width="300"><input class="form-control" name="find" type="text" placeholder=" Keyword Pencarian"></td>
              </tr>
              <tr>
                <td><br></td>
              </tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input class="btn btn-default" type="submit" name="pencarian" value="Cari"></td>
              </tr>
            </table>
          </td>
        </form>
